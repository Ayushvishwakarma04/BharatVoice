  ...
  return (
    <div className="App">
      ...
      <div className="app__header">
        ...
        <div className="signupButton" >
          {user ? (
            ...
            variant="contained" color="primary" className="signOutButton">Logout</Button>
          ) : (
      ...
      <div className="upload_message" >
        ...
        <p><b>Welcome to BharatVoice!</b> To avial new Scheme, the user has to sign up for the application first using any mail ID. For example : "xyz@gmail.com". User can Sign-In using the same credentials again and again. <br /><br />
        <b>For accessing a Post</b> you need to sign-in first. Then click the "UPLOAD PHOTO" Button. Select a Photo from your device, add suitable qualification in the details, and then click "SUMBIT" Button. Wait till the photo gets uploaded. And then BOOM!!! Your details has been submitted(Scroll a bit if you don't find your details at the top).
        <br /><br />
        <b>Hope you have a Great time exploring the Application 💖 !!!</b>
        </p>
        <Button onClick={() => setOpenSignIn(true)} className="upload_signInButton" color="primary" variant="contained" >Sign In</Button>
